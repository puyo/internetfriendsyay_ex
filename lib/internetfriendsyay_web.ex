defmodule InternetFriendsYayWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: InternetFriendsYayWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {InternetFriendsYayWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import InternetFriendsYayWeb.ErrorHelpers
      import InternetFriendsYayWeb.Gettext
      alias InternetFriendsYayWeb.Router.Helpers, as: Routes
    end
  end
